...
##fields = ['TR.CompanyName', 'TR.F.TotRevenue(Curn=USD).date', 'TR.F.TotRevenue(Curn=USD)','TR.F.TotRevenue(Curn=USD).fxRate', 'TR.F.TotRevenue(Curn=USD).fperiod','TR.F.TotRevenue(Curn=USD).periodenddate','TR.F.TotRevenue(Curn=USD).currency', 'TR.F.TotRevenue(Curn=USD).companyCurrency','TR.UltimateParent']

##you need this
fields = ['TR.SharesHeld','TR.SharesHeld.investorpermid','TR.SharesHeld.date']
df1, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-3CY', 'EDate':'0CY','Frq': 'Y'})
df2, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-6CY', 'EDate':'-3CY','Frq': 'Y'})
df3, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-9CY', 'EDate':'-6CY','Frq': 'Y'})
df4, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-12CY', 'EDate':'-9CY','Frq': 'Y'})
df5, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-15CY', 'EDate':'-12CY','Frq': 'Y'})
df6, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-18CY', 'EDate':'-15CY','Frq': 'Y'})
df7, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-21CY', 'EDate':'-18CY','Frq': 'Y'})
df8, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-24CY', 'EDate':'-21CY','Frq': 'Y'})
df9, e = ek.get_data(screener_exp, fields, {'Period':'FY0', 'SDate': '-25CY', 'EDate':'-24CY','Frq': 'Y'})
...
fields2 = ['TR.InvestorFullName.investorpermid','TR.InvestorFullName', 'TR.InvAddrCountry']
...
fields3 = ['TR.UltPrntPctOfShrsOutHld','TR.UltPrntPctOfShrsOutHld.date','TR.UltPrntPctOfShrsOutHld.investorpermid', 'TR.UltimateParentCountryHQ']
##TR.OwnUltParentId
